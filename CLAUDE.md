...
This project is indexed by GitNexus as **PatchHound** (9451 symbols, 70296 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
