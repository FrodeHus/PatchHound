...
This project is indexed by GitNexus as **PatchHound** (8944 symbols, 65349 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
