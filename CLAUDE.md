...
This project is indexed by GitNexus as **PatchHound** (10994 symbols, 91980 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
