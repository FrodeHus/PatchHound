...
This project is indexed by GitNexus as **PatchHound** (10079 symbols, 79646 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
