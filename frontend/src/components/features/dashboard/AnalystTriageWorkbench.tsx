    ...
    <Card className="rounded-[2rem] border-border/70 bg-[linear-gradient(180deg,color-mix(in_oklab,var(--card)_94%,black),var(--card))] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
      <CardHeader className="gap-4 p-6 pb-3">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <Button
            variant="outline"
            render={<Link to="/vulnerabilities" search={{ page: 1, pageSize: 25, search: '', severity: '', status: '', source: '', minAgeDays: '', publicExploitOnly: false, knownExploitedOnly: false, activeAlertOnly: false, presentOnly: false }} />}
          >
