...
This project is indexed by GitNexus as **PatchHound** (10024 symbols, 79519 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
