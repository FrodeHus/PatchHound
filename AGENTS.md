...
This project is indexed by GitNexus as **PatchHound** (14740 symbols, 81680 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
