...
This project is indexed by GitNexus as **PatchHound** (14995 symbols, 84023 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
