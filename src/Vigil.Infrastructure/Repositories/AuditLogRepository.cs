...
{
    public AuditLogRepository(VigilDbContext dbContext) : base(dbContext) { }
    ...
    public async Task<IReadOnlyList<AuditLogEntry>> GetByTenantAsync(Guid tenantId, CancellationToken ct = default)
        => await DbSet.AsNoTracking()
