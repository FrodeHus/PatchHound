...
{
    public TeamRepository(VigilDbContext dbContext) : base(dbContext) { }
    ...
    public async Task<IReadOnlyList<Team>> GetByTenantAsync(Guid tenantId, CancellationToken ct = default)
    {
        return await DbContext.Teams
