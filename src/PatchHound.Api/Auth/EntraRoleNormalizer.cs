...
{
    private static readonly IReadOnlyDictionary<string, RoleName> RoleMap =
    ...
    {
        return rawRoles
            .Select(role => RoleMap.TryGetValue(role, out var mappedRole) ? mappedRole : ParseFallback(role))
