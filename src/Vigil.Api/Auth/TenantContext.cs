...
public class TenantContext : ITenantContext
{
    ...
    public TenantContext(IHttpContextAccessor httpContextAccessor, VigilDbContext dbContext)
    {
        ...
        {
            var oid = _httpContextAccessor.HttpContext?.User?.FindFirst("http://schemas.microsoft.com/identity/claims/objectidentifier")?.Value
        ...
        _accessibleTenantIds = new Lazy<IReadOnlyList<Guid>>(() =>
        {
            ...
            return dbContext.UserTenantRoles
                .AsNoTracking()
                .IgnoreQueryFilters()
