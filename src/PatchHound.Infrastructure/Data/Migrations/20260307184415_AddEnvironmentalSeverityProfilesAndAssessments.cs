...
namespace PatchHound.Infrastructure.Data.Migrations
{
    ...
    public partial class AddEnvironmentalSeverityProfilesAndAssessments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnvironmentClass = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    InternetReachability = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    ConfidentialityRequirement = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    IntegrityRequirement = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    AvailabilityRequirement = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseSeverity = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    BaseScore = table.Column<decimal>(type: "numeric", nullable: true),
                    BaseVector = table.Column<string>(
                        type: "character varying(256)",
                        maxLength: 256,
                        nullable: true
                    ),
                    EffectiveSeverity = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    EffectiveScore = table.Column<decimal>(type: "numeric", nullable: true),
                    EffectiveVector = table.Column<string>(
                        type: "character varying(256)",
                        maxLength: 256,
                        nullable: true
                    ),
                    FactorsJson = table.Column<string>(type: "text", nullable: false),
                    ReasonSummary = table.Column<string>(
                        type: "character varying(2048)",
                        maxLength: 2048,
                        nullable: false
                    ),
                    CalculationVersion = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "VulnerabilityAssetAssessments");

            migrationBuilder.DropTable(name: "AssetSecurityProfiles");

            migrationBuilder.DropIndex(name: "IX_Assets_SecurityProfileId", table: "Assets");

            migrationBuilder.DropColumn(name: "SecurityProfileId", table: "Assets");
        }
    }
}
