...
public class PatchHoundDbContext : DbContext, IUnitOfWork
{
    ...
    public DbSet<SoftwareSourceIdentity> SoftwareSourceIdentities => Set<SoftwareSourceIdentity>();
    public DbSet<SoftwareRelease> SoftwareReleases => Set<SoftwareRelease>();
    public DbSet<RawDeviceObservation> RawDeviceObservations => Set<RawDeviceObservation>();
    public DbSet<RawSoftwareObservation> RawSoftwareObservations => Set<RawSoftwareObservation>();
    public DbSet<RawInstallationObservation> RawInstallationObservations => Set<RawInstallationObservation>();
    public DbSet<RawVulnerabilityObservation> RawVulnerabilityObservations => Set<RawVulnerabilityObservation>();
    public DbSet<RawExposureObservation> RawExposureObservations => Set<RawExposureObservation>();
    public DbSet<IngestionRunDelta> IngestionRunDeltas => Set<IngestionRunDelta>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder
            .Entity<ApprovedVulnerabilityRemediation>()
            .HasQueryFilter(e => IsSystemContext || AccessibleTenantIds.Contains(e.TenantId));
        modelBuilder
