...
public class SoftwareProductInstallationConfiguration
    : IEntityTypeConfiguration<SoftwareProductInstallation>
{
    public void Configure(EntityTypeBuilder<SoftwareProductInstallation> builder)
    {
