...
namespace PatchHound.Infrastructure.Migrations
{
    ...
    [Migration("20260518063545_GreenfieldIngestion")]
    partial class GreenfieldIngestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.IngestionRunDelta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RunId", "Kind", "EntityId")
                        .IsUnique()
                        .HasDatabaseName("UX_IngestionRunDeltas_Run_Kind_Id");

                    b.ToTable("IngestionRunDeltas");
                });

            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.RawDeviceObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IngestionRunId", "SourceSystemId", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("UX_RawDeviceObservations_Run_Source_ExternalId");

                    b.HasIndex("TenantId", "SourceSystemId", "ExternalId");

                    b.ToTable("RawDeviceObservations");
                });

            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.RawExposureObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IngestionRunId", "TenantId", "DeviceExternalId");

                    b.HasIndex("IngestionRunId", "TenantId", "VulnerabilityExternalId");

                    b.HasIndex("IngestionRunId", "SourceSystemId", "DeviceExternalId", "VulnerabilityExternalId", "SoftwareExternalId")
                        .IsUnique()
                        .HasDatabaseName("UX_RawExposureObservations_Run_Device_Vulnerability_Software");

                    b.ToTable("RawExposureObservations");
                });

            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.RawInstallationObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IngestionRunId", "TenantId", "SoftwareExternalId");

                    b.HasIndex("IngestionRunId", "SourceSystemId", "DeviceExternalId", "SoftwareExternalId")
                        .IsUnique()
                        .HasDatabaseName("UX_RawInstallationObservations_Run_Device_Software");

                    b.ToTable("RawInstallationObservations");
                });

            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.RawSoftwareObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IngestionRunId", "CanonicalProductKey");
                    ...
                    b.ToTable("RawSoftwareObservations");
                });

            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.RawVulnerabilityObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IngestionRunId", "SourceSystemId", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("UX_RawVulnerabilityObservations_Run_Source_ExternalId");

                    b.HasIndex("TenantId", "SourceSystemId", "ExternalId");

                    b.ToTable("RawVulnerabilityObservations");
                });

            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.SoftwareRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SoftwareProductId", "NormalizedVersion")
                        .IsUnique()
            ...
            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.SoftwareSourceIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SoftwareSourceIdentities");
                });
            ...
            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.IngestionRunDelta", b =>
                {
                    b.HasOne("PatchHound.Core.Entities.IngestionRun", null)
                        .WithMany()
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PatchHound.Core.Entities.Ingestion.SoftwareSourceIdentity", b =>
                {
                    ...
                    b.HasOne("PatchHound.Core.Entities.Ingestion.SoftwareRelease", null)
                        .WithMany()
